 ...
 * @author diosl
 */
public class RespuestaLike extends ConnectionAccess implements IRespuesta {
    ...
    public RespuestaLike(Ventana ventana, Data data) {
    ...
    public void sendWelcome(Ventana ventana) {
        ...
        ventana.getTextArea().append("Función Respuesta Like" + "\n" + "\n");
    }
}
