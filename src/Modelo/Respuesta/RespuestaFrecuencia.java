 ...
 * @author diosl
 */
public class RespuestaFrecuencia extends ConnectionAccess implements IRespuesta {
    ...
    public RespuestaFrecuencia(Ventana ventana, Data data) {
    ...
    public void sendWelcome(Ventana ventana) {
        ...
        ventana.getTextArea().append("Función Respuesta por Frecuencia" + "\n" + "\n");
    }
}
